...
```
    ...
    ##                  Movie_Title  Release_Date China_Gross US_happy Worldwide_sad
...
```
    ...
    ## 7            6.00e+08            1300000000 700000000         <NA>
...
```
    ...
    ## 4             421000000 200000000 Ron Clements

``` r
df_left <- left_join(df_directors, df, by = "Movie_Title")
```
...
```
    ...
    ## 3             6.0e+08            1300000000 700000000
...
A common mistake! There’s an important difference between **mapping** a
variable to an aesthetic and **setting** an aesthetic to a fixed value.
...
![](bigdata_L2-github_files/figure-gfm/unnamed-chunk-23-1.png)<!-- -->
...
![](bigdata_L2-github_files/figure-gfm/unnamed-chunk-24-1.png)<!-- -->
...
![](bigdata_L2-github_files/figure-gfm/unnamed-chunk-25-1.png)<!-- -->

R thinks “purple” is a variable name, recycles it for every row, and
picks its default color (red) — not what you wanted!
...
![](bigdata_L2-github_files/figure-gfm/unnamed-chunk-26-1.png)<!-- -->
...
![](bigdata_L2-github_files/figure-gfm/unnamed-chunk-27-1.png)<!-- -->
...
![](bigdata_L2-github_files/figure-gfm/unnamed-chunk-28-1.png)<!-- -->
...
![](bigdata_L2-github_files/figure-gfm/unnamed-chunk-29-1.png)<!-- -->
...
![](bigdata_L2-github_files/figure-gfm/unnamed-chunk-32-1.png)<!-- -->
...
![](bigdata_L2-github_files/figure-gfm/unnamed-chunk-33-1.png)<!-- -->
...
![](bigdata_L2-github_files/figure-gfm/unnamed-chunk-34-1.png)<!-- -->
...
![](bigdata_L2-github_files/figure-gfm/unnamed-chunk-40-1.png)<!-- -->

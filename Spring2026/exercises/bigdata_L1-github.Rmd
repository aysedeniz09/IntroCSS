...
You can also add:
- OPTIONAL: a **chunk label** (for identification)
...
You can set options that apply to all code chunks in the document.
This is usually done in the first chunk of the file.
